...
export default function IAChatButton() {
  ...
  return (
    <>
      ...
      {open && (
        <div id="ia-chat-box" className="fixed bottom-24 right-8 z-50 w-80 max-w-xs bg-black rounded-2xl shadow-2xl border border-purple-700 flex flex-col">
